  ...
  const values = [
    {
      ...
      description:
        "We believe diversity drives innovation. Our community welcomes developers of all backgrounds, experience levels, and perspectives.",
      icon: (
        <svg
    ...
    },
    {
      ...
      description:
        "We foster a culture of continuous learning where everyone is both a teacher and a student, sharing experiences and growing together.",
      icon: (
        <svg
          className="w-8 h-8 text-primary-600"
          fill="none"
    ...
    },
    {
      ...
      description:
        "We stay at the forefront of JavaScript development, exploring new technologies and pushing the boundaries of what's possible.",
      icon: (
        <svg
          className="w-8 h-8 text-primary-600"
          fill="none"
    ...
    },
    {
      ...
      description:
        "Every decision we make prioritizes the benefit and growth of our community members and the broader tech ecosystem in Albania.",
      icon: (
        <svg
          className="w-8 h-8 text-primary-600"
          fill="none"
      ...
      <section className="relative pt-28 md:pt-36 pb-20 overflow-hidden">
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-dark-secondary max-w-3xl mx-auto leading-relaxed">
            We&apos;re passionate developers, designers, and tech enthusiasts
            united by our love for JavaScript and commitment to growing
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-dark-secondary leading-relaxed mb-6">
                TiranaJS Community exists to foster growth, innovation, and
                collaboration among JavaScript developers in Albania. We believe
                that by bringing together passionate individuals, we can create
                a thriving ecosystem that benefits everyone.
              </p>
              <p className="text-dark-secondary leading-relaxed mb-6">
                Our mission is to provide a platform where developers can learn
                from each other, share their experiences, and build meaningful
                connections that last beyond our monthly events.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-dark-secondary max-w-2xl mx-auto">
              These core values guide everything we do and help create a
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-dark-secondary mb-8 leading-relaxed">
            ...
            JavaScript journey, there&apos;s a place for you in TiranaJS
            Community.
          </p>
