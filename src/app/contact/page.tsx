...
export default function ContactPage() {
  ...
  const socialLinks = [
    ...
    },
    {
      ...
      description:
        "Follow us for behind-the-scenes content and community highlights",
    },
    {
      name: "GitHub",
      ...
      <section className="relative pt-24 sm:pt-28 md:pt-36 pb-16 md:pb-20 overflow-hidden">
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-base sm:text-lg md:text-xl text-dark-secondary max-w-3xl mx-auto leading-relaxed">
            Have a question, want to speak at our events, or interested in
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-dark-secondary text-sm">
                    Send us an email at the contact above. We review all
                    proposals and get back to speakers within a week.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-dark-secondary text-sm">
                    Yes! We work with companies that align with our values.
                ...
                <div>
                  ...
                  <p className="text-dark-secondary text-sm">
                    ...
                    events, content creation, and community management. Let us
                    know your interests!
                  </p>
                </div>
              </div>
