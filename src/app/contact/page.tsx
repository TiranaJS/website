              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-dark-secondary">hello@tiranajs.org</p>
                  </div>
                </div>
              ...
              <div className="space-y-4">
                {socialLinks.map((social, index) => (
                  <a
                    ...
                    className="flex items-start space-x-4 p-4 rounded-2xl hover:bg-primary-50 transition-colors group"
                  >
                    <div className="text-primary-600 group-hover:text-primary-700 transition-colors">
                      {social.icon}
                    </div>
                    <div>
                      <h4 className="font-medium text-dark-primary group-hover:text-primary-700 transition-colors">
                        {social.name}
                      </h4>
