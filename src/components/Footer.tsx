...
const Footer: React.FC = () => {
  ...
  const socialLinks = [
    {
      name: 'Luma',
      href: 'https://lu.ma/tiranajs',
      icon: (
        <svg className="w-5 h-5" viewBox="0 0 133 134" fill="currentColor" aria-hidden="true">
    ...
    {
      name: 'Twitter',
      href: 'https://twitter.com/tiranajs',
      icon: (
    ...
    {
      name: 'LinkedIn',
      href: 'https://linkedin.com/company/tiranajs',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'Instagram',
      href: 'https://instagram.com/tiranajs',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'GitHub',
      href: 'https://github.com/tiranajs',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="flex space-x-4 mt-4 sm:mt-0">
            {socialLinks.map((social) => (
              <a
                ...
                className="text-primary-300 hover:text-white transition-colors duration-200 p-2 rounded-xl hover:bg-primary-800"
